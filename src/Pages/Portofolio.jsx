...
const ToggleButton = ({ onClick, isShowingMore, isDark }) => (
  <button
    onClick={onClick}
    className={`
      px-3 py-1.5
...
// Tech Stack List - Tambahkan tech stack baru di sini
const techStacks = [
...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    AOS.init({
      once: true, // Animasi hanya sekali, tidak repeat
      duration: 800,
      easing: 'ease-in-out',
      disable: 'mobile', // Disable di mobile untuk performa
    });
  }, []);
  ...
  useEffect(() => {
    ...
    // Store in localStorage for compatibility (e.g., ProjectDetail page)
  ...
  return (
    <div className={`md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] ${isDark ? 'bg-slate-900' : 'bg-white'} overflow-hidden transition-colors duration-300`} id="Portofolio">
      ...
      <Box sx={{ width: "100%" }}>
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              bottom: 0,
              background: isDark 
                ? "linear-gradient(180deg, rgba(6, 182, 212, 0.03) 0%, rgba(59, 130, 246, 0.03) 100%)"
                : "linear-gradient(180deg, rgba(6, 182, 212, 0.05) 0%, rgba(59, 130, 246, 0.05) 100%)",
        ...
        >
            ...
            sx={{
              ...
              "& .MuiTab-root": {
                ...
                "&.Mui-selected": {
                  ...
                  boxShadow: isDark 
                    ? "0 4px 15px -3px rgba(6, 182, 212, 0.2)"
                    : "0 4px 15px -3px rgba(6, 182, 212, 0.1)",
                  "& .lucide": {
          ...
          >
            <Tab
              icon={<Code className="mb-2 w-5 h-5 transition-transform duration-300 ease-in-out" />}
              label="Projects"
              {...a11yProps(0)}
            />
            <Tab
              icon={<Award className="mb-2 w-5 h-5 transition-transform duration-300 ease-in-out" />}
              label="Certificates"
              {...a11yProps(1)}
            />
            <Tab
              icon={<Boxes className="mb-2 w-5 h-5 transition-transform duration-300 ease-in-out" />}
              label="Tech Stack"
              {...a11yProps(2)}
            />
          </Tabs>

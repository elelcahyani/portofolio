...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        TechStack: selectedProject.TechStack || selectedProject.tech_stack || [],
        Github: selectedProject.Github || selectedProject.github || 'https://github.com',
        Img: selectedProject.Img || selectedProject.img,
        Images: selectedProject.Images || selectedProject.images || [selectedProject.Img || selectedProject.img],
      };
  ...
  return (
    <div className="min-h-screen px-[2%] sm:px-0 relative overflow-hidden pt-20">
